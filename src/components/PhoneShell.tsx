...
export function PhoneShell({ children }: PhoneShellProps) {
  return (
    <section
      ...
      className="relative min-h-[360px] max-h-[740px] w-[min(360px,calc(100vw-24px))] flex-1 overflow-hidden rounded-[36px] border-[8px] border-slate-950/95 bg-slate-950/90 shadow-phone"
    >
